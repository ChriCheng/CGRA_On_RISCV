...
HD_PWD='C:/Users/76296/Desktop/graduation-project/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log picorv32_axi.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source picorv32_axi.tcl
