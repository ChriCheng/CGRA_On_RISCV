...
#
# Generated by export_simulation on Tue May 14 15:11:07 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './axi_bram.sh' script.

./axi_bram.sh -reset_run
...
./axi_bram.sh -noclean_files

For more information on the script, please type './axi_bram.sh -help'.
