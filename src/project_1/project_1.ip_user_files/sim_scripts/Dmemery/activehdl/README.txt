...
#
# Generated by export_simulation on Wed Apr 10 13:19:54 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './Dmemery.sh' script.

./Dmemery.sh -reset_run
...
./Dmemery.sh -noclean_files

For more information on the script, please type './Dmemery.sh -help'.
