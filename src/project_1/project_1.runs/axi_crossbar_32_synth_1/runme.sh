...
HD_PWD='C:/Users/76296/Desktop/CGRA_On_RISCV/src/project_1/project_1.runs/axi_crossbar_32_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_crossbar_32.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_crossbar_32.tcl
