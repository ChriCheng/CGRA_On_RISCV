...
HD_PWD='C:/Code/Vivado/CGRA_On_RISCV/src/project_1/project_1.runs/Dmemery_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Dmemery.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Dmemery.tcl
