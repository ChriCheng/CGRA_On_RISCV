...
HD_PWD='C:/Users/76296/Desktop/CGRA_On_RISCV/src/project_1/project_1.runs/IMemory_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log IMemory.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source IMemory.tcl
